...
export const QuickLinkCard = ({
  ...
  return (
    <Link
      to={to}
      className="flex min-h-full min-w-full flex-col items-center justify-center rounded-[24px] bg-[var(--color-shell-card)] p-4 transition-transform active:scale-95"
    >
